...
public class BftFinalState {
  ...
  private final PoolFulfilled poolFulfilled;
  ...
  public BftFinalState(
      ...
      final PoolFulfilled poolFulfilled,
    ...
    this.poolFulfilled = poolFulfilled;
   ...
   * Gets pool fulfilled.
   *
   * @return the pool fulfilled
   */
  public PoolFulfilled getPoolfulfilled() {
    return poolFulfilled;
  }
